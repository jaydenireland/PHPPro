...
/**
 * register php-snippet language. This is a copy of the php language with the following changes:
 * Remove the need to use <?php and ?>
 * change from https://github.com/microsoft/monaco-languages/blob/main/src/php/php.ts
 *
 * @param {languages} languages
 */
export default (languages) => {
  languages.register({ id: 'php-snippet' })

  // Register a tokens provider for the language
  languages.setMonarchTokensProvider('php-snippet', {
    tokenizer: {
      root: [
